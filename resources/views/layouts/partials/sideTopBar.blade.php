        ...
        <div class="sidebar-header">
          <div class="logo clearfix">
            ...
            <a id="sidebarToggle" href="javascript:;" class="nav-toggle d-none d-sm-none d-md-none d-lg-block">
              <i data-toggle="collapsed" class="icon-lock toggle-icon"></i>
            </a>
              ...
              <!--
               <li class="has-sub nav-item"><a href="#"><i class="icon-user"></i><span data-i18n="" class="menu-title">Conta</span><span class="tag badge badge-pill badge-danger float-right mr-1 mt-1">7</span></a>
                <ul class="menu-content">
                  ...
                  <li><a href="/users/unidades_atendimento/" class="menu-item">Administrar Unidades</a></li>
                  <li><a href="/users/organizacao/contas" class="menu-item">Administrar Contas</a></li>
                  <li><a href="/users/planos/" class="menu-item">Planos</a></li>
        ...
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <span class="d-lg-none navbar-right navbar-collapse-toggle">
                 <a href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle">
          ...
          <div class="navbar-container">
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
              <ul class="navbar-nav">
                <li class="dropdown nav-item"><a id="dropdownBasic2" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="icon-bell font-medium-3 blue-grey darken-4"></i><span class="notification badge badge-pill badge-danger">3</span>
                    <p class="d-none">Notificações</p></a>
                  <div class="notification-dropdown dropdown-menu dropdown-menu-right">
                    <div class="noti-list ps-container ps-theme-default" data-ps-id="e812fb26-8811-d0d0-1962-0067d6a4b3bd">
                      <a href="/users/pacote_sms/" target="_blank" class="dropdown-item noti-container py-3 border-bottom border-bottom-blue-grey border-bottom-lighten-4"><i class="icon-bell info float-left d-block font-large-1 mt-1 mr-2"></i><span class="noti-wrapper"><span class="noti-title line-height-1 d-block text-bold-400 info">Pacotes de SMS</span><span class="noti-text">Nova forma de confirmar agendamentos!</span></span></a>
                      <a href="/appointments/google_agenda" target="_blank" class="dropdown-item noti-container py-3 border-bottom border-bottom-blue-grey border-bottom-lighten-4"><i class="icon-bell warning float-left d-block font-large-1 mt-1 mr-2"></i><span class="noti-wrapper"><span class="noti-title line-height-1 d-block text-bold-400 warning">Google Agenda</span><span class="noti-text">Integração com o Google Meet</span></span></a>
                      <a href="/blog/category/tutorial/" target="_blank" class="dropdown-item noti-container py-3 border-bottom border-bottom-blue-grey border-bottom-lighten-4"><i class="icon-bell danger float-left d-block font-large-1 mt-1 mr-2"></i><span class="noti-wrapper"><span class="noti-title line-height-1 d-block text-bold-400 danger">Tutoriais</span><span class="noti-text">Precisa de ajuda com a configuração?</span></span></a>
                      <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 3px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; right: 3px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></div><a class="noti-footer primary text-center d-block border-top border-top-blue-grey border-top-lighten-4 text-bold-400 py-1">Painel de Avisos</a>
                  </div>
                </li>
                ...
                <li class="nav-item d-none d-lg-block"><a href="#" data-toogle="dropdown" class="nav-link position-relative notification-sidebar-toggle"><i class="icon-align-justify font-medium-3 blue-grey darken-4"></i>
                    <p class="d-none">Notifications Sidebar</p></a>
                </li>
              </ul>
            </div>
          </div>
