    ...
    <div id="wrap">
      <div class="row">
        <div class="col-xl-3 col-lg-6 col-md-6 col-6">
            <div class="content-header">{{$user->u_name}}</div>
              ...
              <table class="table table-sm table-responsive-sm text-center" style="font-size:90%;" id="tabela_agendas">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a class="success p-0" data-original-title="" title="" target="_blank" href="/agendamentos/configurar_agenda/2226"><span data-toggle="tooltip" data-placement="right" title="Configurar Agenda"><i class="icon-edit font-medium-3 mr-2"></i></span></a></td>
                  </tr>
                  <tr>
                    ...
                    <td><a class="btn white btn-round btn-primary">4,4%</a></td>
                      <td><a class="btn white btn-round btn-primary">Ativo</a></td>
                    <td><a class="success p-0" data-original-title="" title="" target="_blank" href="/agendamentos/configurar_agenda/2176"><span data-toggle="tooltip" data-placement="right" title="Configurar Agenda"><i class="icon-edit font-medium-3 mr-2"></i></span></a></td>
                  </tr>
